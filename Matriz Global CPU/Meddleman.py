...
class ValueCondition:
    ...
    def __str__(self):
        return str(self.index[0]) + " " + str(self.index[1])
...
class Matrix:
    ...
    def saveValueMatrix(self):
        np.savetxt('output/output_serial.txt', self.values_matrix, fmt='%.0f', header="Matrix de Valores:")
